...
const projects = [
  {
    title: "BioSecure Access System (Voice + Face Authentication)",
    description: "Developed a multimodal biometric authentication system combining voice and face recognition. Integrated speaker verification using ECAPA-TDNN and face recognition using DeepFace, with a React frontend and Flask-based REST APIs.",
    tech: ["Flask", "React", "Deep Learning", "Python"],
  ...
  },
  {
    ...
    description: "Built a secure web platform for managing digital evidence with role-based access control. Implemented evidence hashing to ensure data integrity and designed a case management system with audit logging.",
