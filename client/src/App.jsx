    ...
    <div className="app-root" style={{ width: '100%', minHeight: '100vh', backgroundColor: 'transparent' }}>
      ...
      {loaded && (
        <div className="portfolio-content" style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
          ...
          {/* Footer */}
          <footer className="text-center py-8 text-gray-500 text-sm border-t border-[rgba(234,179,8,0.08)] bg-white/80 backdrop-blur-md" style={{ zIndex: 10, textAlign: 'center', padding: '32px 24px' }}>
